...
Using the sample function, we can fill each cell randomly with either 0 or 1. This simulates an adjancency matrix for a network where connections between people are random.
