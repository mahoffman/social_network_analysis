...
Let's build an edge list together in Excel. Imagine we want to track patterns of monetary gift giving in a household (i.e. whether person A gives person B money). We construct an edge list, where column A is the Ego (the gift giver) and column B  is the Alter (the gift receiver). We then fill in instances, or relationships, of gift giving from Ego to Alter. Below is an example:

**Gift giving edge list (Hoffman family)**
