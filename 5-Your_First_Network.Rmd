...
This folder, what R people call the "Working Directory", is where you should keep all of your data and R scripts for this project. Since we just created the project that we will use for the remainder of the tutorials, it is the best place for you to put all of the class materials. 
...
Great! Now, inside of your class directory, you should see a new file titled "money_edgelist" (or whatever you chose to name it).  In the following section, we will learn how to read that edgelist into R. 
...
Now that igraph is installed, we need to use the library() function to load it into R.  You will have to do this everytime you open RStudio or switch projects if you wish to make use of igraph's functions.
