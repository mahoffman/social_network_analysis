...
cor.test(V(marriageNet)$degree, V(marriageNet)$betweenness) # 0.83
cor.test(V(marriageNet)$degree, V(marriageNet)$eigenvector) # 0.94 
cor.test(V(marriageNet)$degree, V(marriageNet)$closeness) # 0.75
cor.test(V(marriageNet)$betweenness, V(marriageNet)$eigenvector) # .67
cor.test(V(marriageNet)$betweenness, V(marriageNet)$closeness) # .57
